...
dp.create_streaming_table(
    name="tweets_silver",
    comment="Cleaned and transformed tweets with extracted mentions"
)
...
import pyspark.pipelines as dp
from pyspark.sql.functions import col, regexp_replace, explode_outer, lower, to_timestamp

@dp.append_flow(target="tweets_silver")
def silver_transformation_flow():
    return (
        spark.readStream.table("workspace.default.tweets_bronze")
